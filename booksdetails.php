...
<?php
//cheaking if a book in logged in
if(!isset($_SESSION['librarian_id']))
	...
	$query="SELECT * FROM book WHERE isDeleted=0 ORDER BY title";//is delete 1-deleted or 0-not
	...
	if($books)
	{
		while($book = mysqli_fetch_assoc($books)) //$book = 1 record
		{
			...
			$book_list .="<td><a href=\"modifybook.php?book_isbn={$book['isbn']}\">Edit</a></td>";
			$book_list .="<td><a href=\"delete-book.php?book_isbn={$book['isbn']}\"onclick=\"return confirm('Are you sure?');\">Delete</a></td>";
			$book_list .="</tr>";
		}
	}
	else
...
/* webpage Layouts ------------------------------------*/
	...
	<header id="color">
		...
		<h3 align="center">Hi! <?php echo $_SESSION['librarian_name']; ?>, This is book details.</h3>
		<br><br>
