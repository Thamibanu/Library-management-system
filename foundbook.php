...
<?php
//checking if a search is conducted - Result page
if(!isset($_SESSION['member_id']))
	...
	$query="SELECT * FROM book WHERE category='".$_SESSION['category']."'";//is delete 1 means deleted or 0 means not
...
<style>
	...
	<header id="color">
		...
		<h3 align="center">Hi! <?php echo $_SESSION['first_name']; ?>, This is your filtered books.</h3>
		<br><br>
		
		<h1 align="center">Filtered Books</h1>
